...
document.getElementById("my-form").addEventListener("submit", function (event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbx0zbD2FB0eJa1JyCKm-JwfmXNIO191n6xNydPzrwFXZ3DQxqx_d2VtnhPuRyvgIPL1/exec', {
    method: 'POST',
...
async function loadComments() {
  const response = await fetch('https://script.google.com/macros/s/AKfycbx0zbD2FB0eJa1JyCKm-JwfmXNIO191n6xNydPzrwFXZ3DQxqx_d2VtnhPuRyvgIPL1/exec'); // Use the Web App URL here
